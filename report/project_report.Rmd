...
1. The attribute had at least 60% missingness.
    + Wind Chill (which is also a function of Temperature and Wind speed) and Precipitation (which also has low variability)
...
g <- ggplot(estimates, aes(x = reorder(as.factor(Variable), -abs(Estimates)), y = Estimates)) + 
...
```{r, echo = FALSE}
#####We have this table of ordinal nets estimates but not any description above yet.
# create table  
