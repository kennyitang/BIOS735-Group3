...
```{r, echo = FALSE}
#####We have this table of ordinal net estimates but not any description above yet.
# create table  
down_df <- data.frame(Reference = c("1", "2", "3"), 
                       Predict.1 = c(33959, 813, 543), 
                       Predict.2 = c(2753, 5207, 114), 
                       Predict.3 = c(0,0,0), 
